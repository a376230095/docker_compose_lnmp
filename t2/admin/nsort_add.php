...
if($S_title!=""){
	mysqli_query($conn,"insert into sl_nsort(S_pic,S_title,S_content,S_order,S_sub,S_show,S_keywords) values('$S_pic','$S_title','$S_content',$S_order,$S_sub,$S_show,'$S_keywords')");
